...
const TRANSLATIONS = {
  ...
  JA: {
    ...
    acc_choose_lang:  '言語を選択',
    acc_tab_home:     '🏠 ホーム',
    acc_tab_news:     '📰 ニュース',
    acc_tab_status:   'ステータス',
    acc_tab_elite:    '⭐ エリート',
    acc_tab_offers:   '💼 求人',
    acc_tab_cv:       '📄 プロ履歴書',
    acc_tab_discussion: '💬 ディレクトリ・チャット',
    acc_tab_faq:      '📖 よくある質問',
    acc_search_title: '職業を検索',
    acc_all_jobs:     'すべての職業',
    acc_nav_profile:  'マイプロフィール',
    acc_nav_discussion: 'チャット',
    acc_nav_live:     'ライブ',
    acc_nav_messages: 'メッセージ',
    pv_report_confirm_text: '次の理由で報告を確認：',
    pv_report_confirm_btn: '✓ 確認',
    pv_report_cancel_selection: '変更',
    pv_profile_not_found: '⚠ プロフィールが見つかりません。',
  },
